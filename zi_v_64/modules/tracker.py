...
class FlowTracker:
    ...
    def __init__(self, cam_id: int, src: str, classes: list[str], cfg: dict, tasks: list[str] | None = None, mode: str = "both", src_type: str = "http"):
        ...
        self.duplicate_filter_threshold = cfg.get("duplicate_filter_threshold", 1.0)

        self.dup_filter = DuplicateFilter(self.duplicate_filter_threshold) if self.duplicate_filter_enabled else None
