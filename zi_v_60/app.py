"""Crowd management system version 60."""
...
from zi_v_60.core.config import load_config, save_config
from zi_v_60.core.tracker_manager import (
    load_cameras,
    start_tracker,
    stop_tracker,
    reset_counts,
...
from zi_v_60.modules.tracker import FlowTracker
from zi_v_60.modules.alerts import AlertWorker
from zi_v_60.modules.utils import lock, SNAP_DIR
...
# Routers
from zi_v_60.routers import dashboard, settings, cameras as cam_routes, reports, ppe_reports, alerts
