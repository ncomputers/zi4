...
from zi_v_65.modules.tracker import FlowTracker
...
def make_tracker(src_type):
    with mock.patch('zi_v_65.modules.tracker.YOLO', DummyYOLO), \
         mock.patch('zi_v_65.modules.tracker.redis.Redis.from_url') as rmock:
